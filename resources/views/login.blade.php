            ...
            <form method="POST" action="/login" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input name="email" type="email" required="" class="form-control form-control-prepended @error('email') is-invalid @enderror" placeholder="Masukan Alamat Email">
                ...
                <div class="form-group text-center mb-0">
                    ...
                    Belum punya akun? <a class="text-underline" href="/register">Daftar</a>
                </div>
            </form>
        </div>
    </div>
